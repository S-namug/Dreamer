...
/* @atoms/forms/_multi-value.twig */
class __TwigTemplate_adaa6668850046d8804f5c7089f3aff9a90c4852562357ee7395396ddf28aa64 extends \Twig\Template
{
    ...
    ";
            ...
            if ($this->getAttribute(($context["description"] ?? null), "content", [])) {
                // line 26
                echo "      <div";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["description"] ?? null), "attributes", []), "addClass", [0 => "form-item__description"], "method")), "html", null, true);
                echo " >";
...
";
  ...
  ";
    ...
    {
        return "@atoms/forms/_multi-value.twig";
    }
    ...
    {
        return new Source("", "@atoms/forms/_multi-value.twig", "/app/web/themes/custom/dreamer_theme/components/01-atoms/forms/_multi-value.twig");
    }
}
