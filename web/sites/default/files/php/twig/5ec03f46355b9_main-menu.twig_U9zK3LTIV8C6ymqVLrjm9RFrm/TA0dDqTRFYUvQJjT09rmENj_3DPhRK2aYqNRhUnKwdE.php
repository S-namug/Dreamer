...
class __TwigTemplate_b7722428f01a4aa4d0ef4f77ea45b27bb27b6cbe9c035d1f6a60f4dd99c5ec05 extends \Twig\Template
{
    ...
    {
        // line 1
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("dreamer_theme/main-menu"), "html", null, true);
        echo "
...
";
    ...
    {
        return new Source("", "@molecules/menus/main-menu/main-menu.twig", "/app/web/themes/custom/dreamer_theme/components/02-molecules/menus/main-menu/main-menu.twig");
    }
}
