...
";
    ...
    public function block_header__branding($context, array $blocks = [])
    {
        // line 11
        echo "          ";
        $this->loadTemplate("@organisms/site/site-header/site-header.twig", "@organisms/site/site-header/site-header.twig", 11, "693197635")->display(twig_array_merge($context, ["link_base_class" => "logo-link", "link_url" => ((        // line 13
...
/* @organisms/site/site-header/site-header.twig */
class __TwigTemplate_78e55a89b1c5974980fd19e6f4bfbf37587d5d4ff744cbfa697b21d75c690db1___693197635 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
